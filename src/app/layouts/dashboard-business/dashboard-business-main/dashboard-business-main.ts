...
@Component({
  selector: 'app-dashboard-business-main',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './dashboard-business-main.html',
  styleUrls: ['./dashboard-business-main.css'],
  encapsulation: ViewEncapsulation.None
})
export class DashboardBusinessMainComponent implements OnInit {
