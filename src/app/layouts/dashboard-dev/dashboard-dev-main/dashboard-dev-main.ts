...
@Component({
  selector: 'app-dashboard-dev-main',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './dashboard-dev-main.html',
  styleUrls: ['./dashboard-dev-main.css'],
  encapsulation: ViewEncapsulation.None
})
export class DashboardDevMainComponent implements OnInit {
