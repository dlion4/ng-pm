...
@Component({
  selector: 'app-dashboard-utility-header', standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './dashboard-utility-header.html',
  styleUrls: ['./dashboard-utility-header.css'],
  encapsulation: ViewEncapsulation.None
})
export class DashboardUtilityHeaderComponent implements OnInit {
