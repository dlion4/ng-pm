...
@Component({
  selector: 'app-dashboard-cards-header', standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './dashboard-cards-header.html',
  styleUrls: ['./dashboard-cards-header.css'],
  encapsulation: ViewEncapsulation.None
})
export class DashboardCardsHeaderComponent implements OnInit {
